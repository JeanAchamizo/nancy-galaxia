...
console.log('Started:',await evaluate("JSON.stringify({started,controls:!document.getElementById('controls').hidden,audioReady:audio.readyState,audioPlaying:!audio.paused})"));
await evaluate("document.getElementById('letter-button').click()");
console.log('Letter:',await evaluate("document.getElementById('letter').open"));
await evaluate("document.getElementById('close-letter').click();document.getElementById('motion-toggle').click()");
console.log('Paused:',await evaluate('paused'));
